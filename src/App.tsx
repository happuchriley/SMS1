...
import ViewStatement from "./pages/billing/ViewStatement";
...
import EditPayment from "./pages/fee-collection/EditPayment";
...
import SetupSalaryStructure from "./pages/payroll/SetupSalaryStructure";
import PayReports from "./pages/payroll/PayReports";
// Finance Entries
    ...
    <ModalProvider>
      ...
      >
        <Routes>
          ...
          />
          <Route
            path="/fee-collection/edit-payment"
            element={
              <PrivateRoute>
                <EditPayment />
              </PrivateRoute>
