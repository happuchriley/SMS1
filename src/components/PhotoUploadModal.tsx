import React, { useState, useRef, useCallback, useEffect, DragEvent, ChangeEvent, MouseEvent } from 'react';
...
const PhotoUploadModal: React.FC<PhotoUploadModalProps> = ({ isOpen, onClose, onImageSelect, currentPreview }) => {
            ...
            {preview ? (
              <div className="relative w-full">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mt-4 sm:hidden">
                  <button
                    onClick={handleSelectClick}
                    className="flex-1 px-4 py-3 bg-primary-500 text-white rounded-md font-semibold hover:bg-primary-700 transition-colors shadow-md"
                  >
                    <i className="fas fa-edit mr-2"></i>
                    Change Photo
                  </button>
              ...
              <>
                <div className={`mb-4 sm:mb-6 ${isDragging ? 'scale-110' : ''} transition-transform`}>
                  <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full bg-primary-500/10 flex items-center justify-center">
                    <i className="fas fa-cloud-upload-alt text-primary-500 text-2xl sm:text-3xl md:text-4xl"></i>
                  </div>
                </div>
                ...
                <div className="text-center">
                  ...
                  <button
                    onClick={handleSelectClick}
                    className="px-6 py-3 bg-primary-500 text-white rounded-md font-semibold hover:bg-primary-700 transition-colors shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                  >
