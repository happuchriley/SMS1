...
export default function StudentsListAllPage() {
  ...
  const allRows = useMemo(
    () => mergeRegisteredWithMock(registeredStudents, MOCK_ROWS),
    [registeredStudents]
  )
  ...
  const handleExportExcel = () => {
    exportToExcel(COLUMNS, exportRows, 'students-list', 'Students', columnVisibility)
    showFeedback('Excel file downloaded.')
  }
  const handleExportCSV = () => {
    exportToCSV(COLUMNS, exportRows, 'students-list.csv', columnVisibility)
    showFeedback('CSV file downloaded.')
  }
  const handleExportPDF = () => {
    exportToPDF(COLUMNS, exportRows, 'students-list.pdf', 'Students List', columnVisibility)
    ...
    <div className="students-list-all-page">
      <header className="students-list-all-header">
        <div className="students-list-all-heading">
          <h1 className="students-list-all-title">Manage Student - All</h1>
        ...
        <div className="students-list-all-toolbar">
          <div className="students-list-all-toolbar-left">
            <label className="students-list-all-entries-label">
              <span className="students-list-all-entries-text">Entries per page</span>
              <select
                value={perPage}
                onChange={(e) => {
                ...
                aria-label="Choose how many entries to show per page"
              >
          ...
          <div className="students-list-all-toolbar-right">
            <label className="students-list-all-search-label">
              ...
              <input
                type="search"
                placeholder="Search by name, ID, contact or class…"
                value={searchQuery}
            ...
            <div className="students-list-all-export-btns">
              <button type="button" className="students-list-all-export-btn" title="Copy" onClick={handleCopy}>
                Copy
              </button>
              <button type="button" className="students-list-all-export-btn" title="Excel" onClick={handleExportExcel}>
                Excel
              </button>
              <button type="button" className="students-list-all-export-btn" title="CSV" onClick={handleExportCSV}>
                CSV
              </button>
              <button type="button" className="students-list-all-export-btn" title="PDF" onClick={handleExportPDF}>
                PDF
              </button>
            </div>
        ...
        <div className="students-list-all-footer">
          <div className="students-list-all-info">
            <span className="students-list-all-info-range">
              Showing {totalRows === 0 ? 0 : start + 1}–{Math.min(start + perPage, totalRows)} of {totalRows} students
            </span>
