...
interface ExpenditureStats {
  total: number;
  totalAmount: number;
  byCategory: Record<string, number>;
}

const ExpenditureReport: React.FC = () => {
  ...
  // Filter expenditures
  const filteredExpenditures = useMemo<ExpenditureItem[]>(() => {
  ...
  const handleExport = (): void => {
    toast.showSuccess('Exporting expenditure report...');
  };
