...
interface OtherFeeStats {
  total: number;
  totalAmount: number;
}

const OtherFeeAll: React.FC = () => {
  ...
  const otherFees: OtherFeeItem[] = [
    ...
    { id: 4, date: '2024-01-18', studentId: 'STU004', studentName: 'Emily Brown', feeType: 'Library Fine', amount: 50, paymentMethod: 'Cash', receiptNumber: 'RCP004' },
  ];
  ...
  const handleExport = (): void => {
    toast.showSuccess('Exporting other fees report...');
  };
    ...
    <Layout>
      <div className="mb-5 sm:mb-6 md:mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-3">
          <div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">Other Fee - All</h1>
            <div className="flex items-center gap-2 text-gray-600 text-xs sm:text-sm">
              ...
              <span>/</span>
              <span className="text-gray-900 font-medium">Other Fee - All</span>
            </div>
          </div>
        </div>
