...
const IncomeStatement: React.FC = () => {
  ...
  const income = useMemo<IncomeExpenseItem[]>(() => [
  ...
  const expenses = useMemo<IncomeExpenseItem[]>(() => [
  ...
  const handleGenerate = (): void => {
    if (!dateFrom || !dateTo) {
      toast.showError('Please select date range.');
      return;
    }
    toast.showSuccess('Income statement generated successfully!');
  };

  const handleExport = (): void => {
    const allData: ExportDataItem[] = [
