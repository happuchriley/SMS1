...
const FinancialReportsCreditorsReport: React.FC = () => {
  ...
  const handleExport = (): void => {
    toast.showSuccess('Exporting creditors report...');
  };
...
export default FinancialReportsCreditorsReport;
