...
const SchoolInfo: React.FC = () => {
  ...
  const [formData, setFormData] = useState<SchoolInfoFormData>({
  ...
  const schoolTypes: string[] = ['Nursery', 'Primary', 'JHS', 'Combined', 'Secondary', 'Technical'];
  const regions: string[] = ['Greater Accra', 'Ashanti', 'Western', 'Eastern', 'Central', 'Northern', 'Volta', 'Upper East', 'Upper West', 'Brong Ahafo', 'Western North', 'Ahafo', 'Bono', 'Bono East', 'Oti', 'North East', 'Savannah'];
  ...
  const loadSchoolInfo = useCallback(async (): Promise<void> => {
    try {
