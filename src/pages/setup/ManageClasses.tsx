...
const ManageClasses: React.FC = () => {
  ...
  const allTeachers: string[] = ['Mr. John Teacher', 'Mrs. Jane Teacher', 'Mr. Michael Teacher', 'Ms. Mary Teacher', 'Ms. Grace Teacher', 'Mr. David Teacher'];
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            ...
            <div className="flex items-end gap-2">
              <select
                ...
                onChange={handleChange}
                className="flex-1 px-4 py-2.5 border-2 border-gray-200 rounded-md text-sm transition-all duration-100 bg-white hover:border-gray-300 focus:outline-none focus:border-primary-500 focus:shadow-[0_0_0_4px_rgba(16,185,129,0.1)]"
              >
              ...
              <button
                type="submit"
                className="px-4 py-2.5 text-sm font-semibold text-white bg-primary-500 rounded-md hover:bg-primary-700 transition-all duration-100"
              >
              ...
              {editingId && (
                <button
                  type="button"
                  onClick={handleClear}
                  className="px-4 py-2.5 text-sm font-semibold text-gray-700 bg-gray-100 rounded-md hover:bg-gray-200 transition-all duration-100"
                >
                  Cancel
                </button>
              )}
          ...
          <table className="table-modern">
            ...
            <tbody>
              {loading ? (
                ...
                classes.map(cls => {
                  const occupancyPercent = cls.currentStudents && cls.capacity ? (cls.currentStudents / cls.capacity) * 100 : 0;
                  return (
                    <tr key={cls.id}>
                      <td className="font-semibold">{cls.className || cls.name}</td>
                      <td>{cls.classCode || cls.code}</td>
                      <td>{cls.capacity}</td>
                      <td>
