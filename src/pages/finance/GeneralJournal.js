...
const GeneralJournal = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    if (!formData.date || !formData.account || !formData.description || (!formData.debitAmount && !formData.creditAmount)) {
    ...
    <Layout>
      <div className="mb-5 sm:mb-6 md:mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-3">
          <div>
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-900 mb-2">General Journal</h1>
      ...
      <div className="bg-white rounded-lg p-4 sm:p-5 md:p-6 shadow-md border border-gray-200">
        <div className="mb-6">
          <h2 className="text-lg sm:text-xl font-semibold text-gray-900 mb-2">Record General Journal Entry</h2>
          <p className="text-sm text-gray-600">Enter general journal transaction details (debit or credit).</p>
        </div>
