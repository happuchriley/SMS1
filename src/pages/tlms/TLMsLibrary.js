...
const TLMsLibrary = () => {
  const [materials] = useState([
    { id: 1, title: 'Mathematics Textbooks - Grade 1', category: 'Textbooks', subject: 'Mathematics', level: 'Primary', fileSize: '25.5 MB', downloads: 145, uploadDate: '2024-01-15', author: 'Mr. John Doe' },
    { id: 2, title: 'English Grammar Guide', category: 'Guides', subject: 'English', level: 'All Levels', fileSize: '8.2 MB', downloads: 89, uploadDate: '2024-01-20', author: 'Ms. Jane Smith' },
    { id: 3, title: 'Science Lab Manual', category: 'Manuals', subject: 'Science', level: 'JHS', fileSize: '12.8 MB', downloads: 67, uploadDate: '2024-01-25', author: 'Dr. Peter Brown' },
    { id: 4, title: 'ICT Worksheets Collection', category: 'Worksheets', subject: 'ICT', level: 'Primary', fileSize: '5.4 MB', downloads: 112, uploadDate: '2024-01-28', author: 'Mr. Mike Wilson' },
    { id: 5, title: 'Mathematics Video Lessons', category: 'Videos', subject: 'Mathematics', level: 'JHS', fileSize: '156.3 MB', downloads: 234, uploadDate: '2024-02-01', author: 'Mr. John Doe' },
  ]);
  ...
  const subjects = ['All Subjects', 'Mathematics', 'English', 'Science', 'ICT', 'Other'];
            ...
            <div key={material.id} className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
              <div className="p-5">
                <div className="flex items-start justify-between mb-3">
                  <i className={`fas ${getFileIcon(material.category)} text-3xl`}></i>
