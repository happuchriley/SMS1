...
const SalaryAdvances = () => {
  ...
  const repaymentMethods = ['Deduct from Salary', 'Manual Payment'];
  ...
  const handleRepayment = (advanceId) => {
  ...
  const handleDelete = (id) => {
    if (window.confirm('Are you sure you want to delete this salary advance record?')) {
