...
const GeneratePayslip = () => {
  ...
  // Sample data
  const departments = ['All Departments', 'Mathematics', 'Administration', 'Finance', 'IT', 'Science'];
  ...
  const filteredStaff = useMemo(() => {
    if (!formData.department || formData.department === 'All Departments') return allStaff;
    return allStaff
