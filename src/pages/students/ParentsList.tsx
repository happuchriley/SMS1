...
const ParentsList: React.FC = () => {
  ...
  const parents = useMemo<ParentData[]>(() => {
  ...
  const handleView = (parent: ParentData): void => {
    showViewModal({
      ...
      fields: [
        ...
        { 
          label: 'Children', 
          accessor: (p: ParentData) => p.children.length,
          render: (_: any, p: ParentData) => (
            <div>
            ...
            <table className="w-full">
              ...
              <tbody>
                {filteredParents.map((parent) => (
                  <tr key={parent.id} className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="p-3">
                      <button
                        ...
                        className="px-3 py-1 text-sm text-primary-500 hover:bg-primary-50 rounded transition-colors"
                      >
